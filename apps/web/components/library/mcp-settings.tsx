 ...
 * never retrievable afterwards — the server stores only its id.
 */
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Give an AI assistant direct access to this library. Bookmark AI speaks the Model Context
          Protocol over HTTP, so any MCP client — Claude Code, Claude Desktop, your own agent — can
          search, browse, and save bookmarks on your behalf using a token you mint here.
        </p>
      </div>
        ...
        <>
          ...
          <div className="space-y-3 border-t pt-5">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                What connected assistants are allowed to do. Applies to every token.
              </p>
            </div>
            {MCP_TOOL_NAMES.map((tool) => (
              <div key={tool} className="space-y-1">
                <div className="flex items-start justify-between gap-4">
                  <label htmlFor={`mcp-tool-${tool}`} className="text-sm font-medium">
          ...
          <div className="space-y-3 border-t pt-5">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                One token per client, so you can revoke a single machine without touching the rest.
          ...
          <Collapsible className="min-w-0 border-t pt-5">
            ...
            <CollapsibleContent className="min-w-0 space-y-3 pt-3">
              ...
              {fresh ? (
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  above if you generated it earlier.
                </p>
              )}
            </CollapsibleContent>
          </Collapsible>
