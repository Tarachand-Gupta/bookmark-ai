...
const ANDROID_ICONS: Record<string, keyof typeof Ionicons.glyphMap> = {
  ...
  // Ask AI: reasoning disclosure.
  brain: "bulb-outline",
  checkmark: "checkmark",
  "checkmark.circle.fill": "checkmark-circle",
  "checkmark.seal.fill": "ribbon-outline",
  ...
  curlybraces: "code-slash-outline",
  // Ask AI: markdown/tool rows, attachments, the composer and thread chrome.
  "doc.richtext": "document-outline",
